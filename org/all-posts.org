...
at ENS, in Paris.  I am starting a PhD under the supervision of Paul-André Melliès and Thierry
Coquand, titled _Linear duality and higher algebraic effects in homotopy type theory_.
...
** Internships
*** Syntax and Semantics of a Linear Dependent Type Theory
/Under the supervision of [[https://www.irif.fr/~mellies][Paul-André Melliès]], at IRIF (Paris)/

The goal of the internship was to study models of dependent type theory, to "linearize"
them, and to attempt to retrofit a theory on them, giving rise to a linear dependent type
theory.  The internship has produced a theory that, contrary to other linear dependent type
theories, effectively mixes linearity and dependence, without distinction between cartesian
and linear types.  This theory relies heavily on the distinction between several contexts,
and a key concept: the singleton type, which permits leaking information between contexts.
...
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :showtoc false :hidemeta true
:END:

** Notes
- /Notes on Categorical models of logic/ [[[https://microbo.eu/notes/categorical-semantics-of-logic.pdf][notes]] (/draft/) ([[https://github.com/jthulhu/notes/blob/release/categorical-semantics-of-logic.typ][src]])]
- /Notes on Representations of 2-groups/ [[[https://microbo.eu/notes/representation-of-2-groups.pdf][notes]] ([[https://github.com/jthulhu/notes/blob/release/representation-of-2-groups.typ][src]])]
- /Notes on (Co)end Calculus/ [[[https://microbo.eu/notes/coend-calculus.pdf][notes]] ([[https://github.com/jthulhu/notes/blob/release/locally-cartesian-closed-categories.typ][src]])]
- /Notes on Locally Cartesian Closed Categories/ [[[https://microbo.eu/notes/locally-cartesian-closed-categories.pdf][notes]] ([[https://github.com/jthulhu/notes/blob/release/locally-cartesian-closed-categories.typ][src]])]
- /Notes on Grothendieck Fibrations/ [[[https://microbo.eu/notes/grothendieck-fibrations.pdf][notes]] ([[https://github.com/jthulhu/notes/blob/release/grothendieck-fibrations.typ][src]])|[[https://microbo.eu/notes/grothendieck-fibrations-slides.pdf][slides]] ([[https://github.com/jthulhu/notes/blob/release/grothendieck-fibrations-slides.typ][src]])]


** Internship thesis
- /Syntax and Semantics of a Linear Dependent Type Theory/ [[[https://microbo.eu/master-thesis/memoire.pdf][thesis]]|[[https://microbo.eu/master-thesis-slides/soutenance.pdf][slides]]]
- /Two-level Type Thoery in Lean, and Applications to Semi-Simplicial Type in HoTT/ [[[/thesis/2ltt-in-lean-and-applications-in-hott/thesis.pdf][thesis]]|[[/thesis/2ltt-in-lean-and-applications-in-hott/slides.pdf][slides]]]
- /Approximate Streaming Regular Pattern Matching/ [[[/thesis/approximate-streaming-regular-pattern-matching/thesis.pdf][thesis]]|[[/thesis/approximate-streaming-regular-pattern-matching/slides.pdf][slides]]]
- /Automatic Benchmark Generation/ [[[/thesis/automatic-benchmark-generation/thesis.pdf][thesis]]|[[/thesis/automatic-benchmark-generation/slides.pdf][slides]] (in French)]
